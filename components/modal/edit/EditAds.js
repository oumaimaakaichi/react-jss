                                    ...
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div className="mt-5 flex flex-col gap-3">
                                                ...
                                                <p className="text-sm text-gray-700 grid grid-cols-2 ">
                                                    <b>user :</b>
                                                    <select className="p-2 rounded-full bg-gray-300 float-right text-gray-900 cursor-not-allowed" disabled>
                                                        <option>Mohamed amine</option>
                                                    </select>
                                                </p>
                                                <p className="text-sm text-gray-700 grid grid-cols-2 ">
                                                    <b>Source :</b>
                                                ...
                                                <p className="text-sm text-gray-700 grid grid-cols-2 ">
                                                    <b>Delegation :</b>
                                                    <select className="p-2 rounded-full bg-gray-100 float-right text-gray-900">
                                                        <option className="p-2 rounded-full bg-gray-100 float-right text-gray-900">Marsa</option>
                                                        <option className="p-2 rounded-full bg-gray-100 float-right text-gray-900">Lac</option>
                                                        <option className="p-2 rounded-full bg-gray-100 float-right text-gray-900">Omrane sup</option>
                                                    </select>

                                                </p>
                                                <p className="text-sm text-gray-700 grid grid-cols-2 ">
                                                    <b>Requested views :</b>
                                                    <input type="text" className="p-2 rounded-full bg-gray-300 float-right text-gray-900 cursor-not-allowed"
                                                        defaultValue={
                                                            props.ads.req_views
                                                        }
                                                        disabled/>
