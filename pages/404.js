...
export default function Custom404() {
    return (
        <div>
            <div className="flex items-center justify-center min-h-screen bg-bold-secondary  bg-fixed bg-cover bg-bottom error-bg"
            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                        ...
                        <Link href="/">
                            <a
                                className="bg-bold-primary px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg">
                                Got to Home
                            </a>
                        </Link>
                    </div>
